...
export const metadata: Metadata = {
  title: "CoffeeShop - Explore the Best Coffee",
  description: "Experience the finest coffee with exquisite flavors at CoffeeShop. Visit us to dive into a world of aroma.",
  openGraph: {
    title: "CoffeeShop - Explore the Best Coffee",
    siteName: "CoffeeShop"
  },
